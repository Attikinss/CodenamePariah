    ...
    public class BehaviourTree : ScriptableObject
    {
        ...
        public BehaviourTree Clone(string name)
        {
            ...
            newTree.Nodes.ForEach(node =>
            {
                ...
                if (root != null)
                {
                    var childNode = newTree.Nodes.Find(itr => itr.GUID == root.Child.GUID);
                    root.ClearChild();
                ...
                if (composite != null)
                {
                    var children = newTree.Nodes.Where(itr => composite.Children.Any(child => itr.GUID == child.GUID)).ToArray();
                ...
                if (decorator != null)
                {
                    var childNode = newTree.Nodes.Find(itr => itr.GUID == decorator.Child.GUID);
